...
$("#addmealplans").on('click',function(){
    ...
    data += "<td style='width: 50em;'><input type='text' class='form-control' name='meal_name[]' id='meal_name"+i+"' placeholder='Enter Meal Title' value='' required><br> <input type='time' class='form-control' id='time"+i+"'  name='time[]' min='09:00' max='17:00'></td>";
    data += "<td style='width: 50em;'><textarea class='form-control' id='meal_description"+i+"' rows='6' placeholder='Add Meal Description...' name='meal_description[]' required></textarea></td></tr>";
    $('#plansec').append(data);
    i++;
});

$("#deletemealplans").on('click', function() {
    var counts = $("#count_items").val();
