...
{   
    ...
    public function index()
    {
        ...
        return view('pages/hometwo', $this->data);
        //return view('/pages/cities/addcity', $this->data);
    }
...
public function addCity(){
    ...
    public function designation_delete($id=''){
        if(empty($id)){
                $this->session->setFlashdata('main_error',"Designation Deletion failed due to unknown ID or ERROR.");
                return redirect()->to('Main/designations');
        }
